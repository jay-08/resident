...
<head>
	...
	<title>Resident Information -  Barangay Profiling System</title>
</head>
<body>
				...
				<div class="panel-header bg-transparent">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-dark fw-bold">Residents</h2>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row mt--2">
						<div class="col-md-12">
                            ...
                            <?php if(isset($_SESSION['message'])): ?>
                                <div class="bg-transparent text-dark alert alert-<?php echo $_SESSION['success']; ?> <?= $_SESSION['success']=='danger' ? 'bg-danger text-light' : null ?>" role="alert">
                            ...
                            <div class="card bg-secondary text-light">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title text-light">Resident Information</div>
										...
										<div class="card-tools">
                                            ...
                                            <a href="model/export_resident_csv.php" class="btn btn-warning btn-border btn-round btn-sm">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">MC-</span>
                                            <input type="number" class="form-control" name="national" placeholder="Enter National ID No." aria-label="ID" aria-describedby="basic-addon1" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" required name="purok">
                                                    ...
                                                    <?php foreach($purok as $row):?>
                                                        <option value="Purok <?= ucwords($row['name']) ?>"><?= $row['name'] ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label>Contact Number</label>
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Enter Contact Number" name="number" min="9" aria-label="Enter Contact Number" aria-describedby="basic-addon1">
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>Barangay ID No.</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1">MC-</span>
                                                <input type="number" class="form-control" name="national" id="nat_id" placeholder="Enter National ID No." aria-label="ID" aria-describedby="basic-addon1">
                                            </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Citizenship</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1">+63</span>
                                                        <input type="text" class="form-control" placeholder="Enter Contact Number" name="number" id="number" aria-label="Enter Contact Number" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
